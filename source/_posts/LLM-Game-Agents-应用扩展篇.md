...
![VOYAGER：GPT-4、三模块与任务队列 / Minecraft / 技能库](/images/llm-game-agents-voyager-arch.svg)
...
![PIANO：并发模块、认知控制器与输出反馈](/images/llm-game-agents-piano-arch.svg)
...
![Agent Hospital：治疗闭环](/images/llm-game-agents-care-loop.svg)
...
![MedAgent-Zero：从治疗反馈到能力进化](/images/llm-game-agents-medagent-zero.svg)
...
![SEAL：领域流程到智能体进化](/images/llm-game-agents-seal-pipeline.svg)
...
![技术演进：基础框架 → 应用扩展 → 趋势](/images/llm-game-agents-tech-roadmap.svg)
...
![多方案能力叠加示意](/images/llm-game-agents-ideal-stack.svg)
